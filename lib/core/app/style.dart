...
const _primary = Color.fromARGB(255, 99, 244, 50);
const _secondary = Color.fromARGB(255, 159, 212, 248);
const _tertiary = Color.fromARGB(255, 234, 196, 254);

const _background = Color.fromARGB(255, 1, 11, 22);
const _onBackground = Color.fromARGB(243, 0, 3, 10);
const _lightest = Color(0xffF9FAFB);

const _darkest = Colors.black;
const _disabled = Color.fromARGB(255, 169, 168, 168);
